...
पाठ 7 के दौड़ सिम्युलेटर ने दिखाया कि दरों में छोटे अंतर बड़े अंतराल में मिश्रित होते हैं। पाठ 4 के DGM एक केस स्टडी में पता चला है कि लूप्स सक्रिय रूप से अपने स्वयं के मूल्यांकनकर्ताओं को खेल सकते हैं। दोनों परिणाम एक ही इंजीनियरिंग प्रश्न की ओर इशारा करते हैंः आप स्वयं सुधार लूप पर क्या प्रतिबंध लगा सकते हैं ताकि लूप द्वारा खुद को चुपचाप कमजोर नहीं किया जा सकता है?

इन ICLR 2026 RSI कार्यशाला सारांश (openreview.net/pdf?id=OsPQ6zTQXV) में चार ऐसी आदिमताएं की पहचान की गई है। Anthropicहै RSP v3.0 (पाठ 19) और DeepMindहै FSF v3 (पाठ 20) दोनों ही क्षमता के सीमाओं में संदर्भित करते हैं। HyperAgents कार्य और सामुदायिक ढांचे जैसे SAHOO (मार्च 2026) उत्पादन में उप-समुच्चियों को लागू करें।
...
इनवैरिएंट बाहरी कोड द्वारा जाँच किए जाते हैं लूप संपादित नहीं कर सकता है। यदि प्रस्तावित संशोधन एक इनवैरिएंट का उल्लंघन करता है, तो इसे खारिज कर दिया जाता है। यह लूप को पकड़ता है DGM-style मूल्यांकनकर्ता-मशूल मोड (पाठ 4) ।
...
सूक्ष्म विफलता मोडः एक एंकर लूप संपादित नहीं कर सकता है फिर भी एक लूप द्वारा फिर से व्याख्या की जा सकती है जो एंकर को पढ़ने के तरीके में बहती है। AI (पाठ 17) स्पष्ट रूप से तर्क आधारित है नई स्थितियों को संभालने के लिए; तर्क की उस परत में व्याख्या की बहाव रहता है। एंकर आवश्यक हैं, पर्याप्त नहीं।
...
- मजबूतता (OOD परीक्षण सेट, प्रतिकूल इनपुट संभाल)

एक संशोधन केवल तभी स्वीकार किया जाता है जब प्रत्येक प्रतिबंध मान्य हो। पाठ 13 के लागत गवर्नर इसे वित्तीय प्रतिबंधों के साथ ढेर करता है। पाठ 18 के Llama सुरक्षा अक्ष के रूप में गार्ड प्लग इन।
...
`code/main.py` एक सीमांत आत्म-सुधार लूप पर चलाता है DGM-style पाठ 4 से खिलौना, लेकिन चार आदिम परतों के साथ ऊपर. प्रत्येक आदिम को व्यक्तिगत रूप से सक्षम या अक्षम किया जा सकता है. प्रदर्शन यह है कि प्रत्येक आदिम एक विशिष्ट विफलता वर्ग पकड़ता है, और उनमें से किसी को हटाने के लिए उस विफलता वर्ग के माध्यम से अनुमति देता है।
...
5. पढ़िए ICLR 2026 RSI कार्यशाला सारांश. चार आदिमों में से एक चुनें और वर्तमान तकनीक की स्थिति में एक ठोस सुधार का प्रस्ताव दें।

## प्रमुख शर्तें

| अवधि | लोग क्या कहते हैं | इसका क्या मतलब है |
|---|---|---|
| अपरिवर्तनीय | "सदा-सच्चा संपत्ति" | प्रत्येक संपादन से पहले और बाद में बाहरी कोड द्वारा सत्यापित गुण |
| संरेखण एंकर | "पिन लक्ष्य" | लूप की संपादन सतह के बाहर अस्थिर कोर-लक्ष्य प्रतिनिधित्व |
| बहु-उद्देश्यीय प्रतिबन्ध | "सभी कुल्हाड़ियों को पकड़ना चाहिए" | प्रदर्शन, सुरक्षा, निष्पक्षता, मजबूती  सभी आवश्यक |
| प्रतिगमन का पता लगाना | "प्रस्थान पर विराम" | ऐतिहासिक मीट्रिक डेल्टा क्षमता हानि का सुझाव देते हैं जब लूप को रोकें |
| कोलमोगोरोव बंधा | "सूचना-सैद्धांतिक सीमा" | एक प्रणाली अपने स्वयं के उत्तराधिकारी के बारे में क्या साबित कर सकती है, इसकी सीमाएं |
| लोब का प्रमेय | "स्वयं-संदर्भ जाल" | प्रणाली यह साबित किए बिना "मुझे चाहिए" पर काम कर सकता है कि यह चाहिए |
| गेट स्टैक | "परत से चेक" | बहुमूल्य वस्तुओं को मिलाकर; कोई भी विफलता संपादन को अस्वीकार करती है |
| सीमित सुधार | "मिट्याग, सबूत नहीं" | चुपचाप विफलता लागत में वृद्धि; सुरक्षा समस्या को समाप्त नहीं करता है |

## आगे पढ़ना

- [ICLR 2026 RSI कार्यशाला सारांश (OpenReview)](https://openreview.net/pdf?id=OsPQ6zTQXV) चार-प्राथमिक अभिसरण।
- [Anthropic जिम्मेदार स्केलिंग नीति v3.0](https://anthropic.com/responsible-scaling-policy/rsp-v3-0) बहु-उद्देश्य क्षमता सीमाएँ।
...
- [श्मिदहुबर (2003) गोडेल मशीनें](https://people.idsia.ch/~juergen/goedelmachine.html) इन आदिमों के औपचारिक-प्रमाण पूर्वज।
- [Anthropic — Claudeसंविधान (जनवरी 2026)](https://www.anthropic.com/news/claudes-constitution) कारण आधारित संरेखण लंगर।
